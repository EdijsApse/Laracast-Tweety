...
<div class="container mx-auto flex justify-center mb-16">
    <div class="row justify-content-center px-12 border border-grey-300 py-8 bg-gray-200 rounded-lg">
        <div class="col-md-8">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div>
                    <button type="submit" class="bg-blue-400 text-white rounded py-2 px-4 hover:bg-blue-500 mr-2">Create Account</button>
                </div>
            </form>
        </div>
    </div>
